    ...
    <section className="relative overflow-hidden bg-background min-h-[calc(100vh-4rem)] lg:h-[calc(100vh-4rem)] flex items-center py-8 lg:py-0">
      ...
      <div className="container mx-auto px-8 md:px-12 lg:px-24 w-full max-w-7xl relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
          ...
          {/* App Preview Mockup */}
          <div className="flex-1 w-full flex justify-center lg:justify-end mt-8 lg:mt-0 h-[50vh] lg:h-[70vh]">
            <div className="relative h-full aspect-[9/19] rounded-[2.5rem] border-[8px] border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 shadow-2xl overflow-hidden flex flex-col transform lg:rotate-2 hover:rotate-0 transition-transform duration-500">
